...
@InputType()
class CategoryItemUpdateInput {
  @ApiProperty({
    required: false,
    type: () => ItemUpdateManyWithoutCategoryItemsInput,
  })
  @ValidateNested()
  @Type(() => ItemUpdateManyWithoutCategoryItemsInput)
  @IsOptional()
  @Field(() => ItemUpdateManyWithoutCategoryItemsInput, {
    nullable: true,
  })
...
export { CategoryItemUpdateInput as CategoryItemUpdateInput };
