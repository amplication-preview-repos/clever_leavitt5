...
import { Prisma, File as PrismaFile, Item as PrismaItem } from "@prisma/client";
...
export class FileServiceBase {
  ...
  async FileUpload(args: FileUploadInput): Promise<User> {
    throw new Error("Not implemented");
  }
  async GetFile(args: string): Promise<User> {
    throw new Error("Not implemented");
  }
